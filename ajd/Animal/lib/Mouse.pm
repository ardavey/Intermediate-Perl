...
This is a mouse, if all goes well, it will squeak quietly

=head1 SUBROUTINES/METHODS

=head2 speak

Partially supplied by Animal, will make a mouse noise
...
sub speak {
  my $class = shift;
  $class->SUPER::speak( @_ );
  print "[but really quietly]\n";
}

=head2 sound

Provided the animal noise
