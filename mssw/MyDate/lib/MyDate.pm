...
sub new {
    my $t = localtime;
    return bless { t => $t }, $_[0];
}

=head2 AUTOLOAD

for all your autoload-y needs
...
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=MyDate>.  I will be notified, and then youll
